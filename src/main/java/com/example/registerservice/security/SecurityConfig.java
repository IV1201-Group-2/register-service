...
public class SecurityConfig {
     ...
     * @throws Exception thrown if an error occurs during the SecurityFilterChain configuration.
     */
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        .requestMatchers("/api/register", "/error", "/api/registeredSuccessfully").permitAll()
                );
